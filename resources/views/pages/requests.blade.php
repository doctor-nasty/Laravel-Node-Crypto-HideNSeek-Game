    ...
    <div class="content-wrapper">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb breadcrumb-custom">
                <li class="breadcrumb-item"><a href="{{ url('') }}">@lang('requests.main')</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>@lang('requests.requests')</span></li>
            </ol>
        </nav>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                            <h4 class="card-title mb-0">@lang('requests.title')</h4>

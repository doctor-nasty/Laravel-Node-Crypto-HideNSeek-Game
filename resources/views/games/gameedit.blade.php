    ...
    <div class="content-wrapper">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb breadcrumb-custom">
                <li class="breadcrumb-item"><a href="{{ url('') }}">@lang('gameedit.dashboard')</a></li>
                <li class="breadcrumb-item"><a href="{{ url('games') }}">@lang('gameedit.games')</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>@lang('gameedit.edit') {{ $game->title }}</span></li>
            </ol>
        </nav>
